...
while url_index < len(url_list):
    try:
        ...
        url="http://www.co-journal.com/EN/1000-1093/current.shtml"
        ...
        languageList =[currentSoup,
                       get_soup("http://www.co-journal.com/CN/1000-1093/current.shtml")]
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                doiForPdf = DOI if DOI != "" else All_articles[article_index].get("id").split("art")[-1]
                token=get_token("http://www.co-journal.com/EN/1000-1093/current.shtml")
                pdf_link="http://www.co-journal.com/EN/PDF/{0}?token={1}".format(doiForPdf,token)
