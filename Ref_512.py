...
while url_index < len(url_list):
    try:
        ...
        url="http://heuxb.hrbeu.edu.cn/api/api/Web/LastIssueList?_t=&PageSize=0&IssueId=0"
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Article_link = f"http://heuxb.hrbeu.edu.cn/en/#/digest?ArticleID={All_articles[article_index]["ArticleID"]}"
                ...
                pdf_link=f"http://heuxb.hrbeu.edu.cn/api/api/Web/OpenArticleFilebyGuidNew?Id={All_articles[article_index]["PDFFileNameUrlGUID"]}"
