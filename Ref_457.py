...
while url_index < len(url_list):
    try:
        ...
        url="http://www.jasp.com.cn/hkdlxb/en/article/current"
        ...
        attachment = None
        pdf_count = 1
        baseUrl="http://www.jasp.com.cn"

        currentSoup=get_soup(url)

        languageList =[currentSoup,
                       get_soup("http://www.jasp.com.cn/hkdlxb/index.htm")]

        All_articles=currentSoup.find("div",class_="articleListBox").findAll("div",class_="article-list")
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Article_link = baseUrl+Art_index.find("div",class_="article-list-title").a["href"]
                ...
                try:
                    ...
                    Year,Volume,Issue,Identifier=re.search(r"(\d{4}), (\d+)\((\d+)\): (\w+\d+).",yearPagerange).groups()
                except:
                    Year,Volume,Issue,Identifier="","","",""
                ...
                pdf_id=Art_index["id"]
                pdf_link=f"http://www.jasp.com.cn/hkdlxb/article/exportPdf?id={pdf_id}&language=en"

                error_variable = "xml link"
                xml_link=f"http://www.jasp.com.cn/hkdlxb/article/exportXML?ids={pdf_id}&downType=XML&language=en"
                ...
                if Check_duplicate.lower() == "true" and check_value:
                    ...
                    pdf_headers = {
                        ...
                        #"cookie": "JSESSIONID=67454DB4E7D7C85888D2EE63C03E411E; _sowise_user_sessionid_=99a24e03-db49-4d97-a197-c7a6ac62bd6a; X-CSRF-Token=c4c68cc4527579f5b46f0a0eb3f27f0cf3e2603410c376c51f726b2bfa9e1b99",
                        "host": "www.jasp.com.cn",
                        "referer": "http://www.jasp.com.cn/hkdlxb//indexen.htm",
                    ...
                    with open(output_fimeName_xml, "wb") as file:
                        file.write(requests.get(xml_link,headers=pdf_headers).content)
