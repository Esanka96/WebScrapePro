...
def getDOI(pdf_link):
    try:
        ...
        with pdfplumber.open(pdf_content) as pdf:
            ...
            text = page.split("\n")
            try:
                index = next((i for i, s in enumerate(text) if "doi.org" in s), None)
...
while url_index < len(url_list):
    try:
        ...
        attachment = None
        pdf_count = 1
        baseUrl="https://www.aes.org.cn/nyhjkxxben/ch/"

        currentSoup=get_soup(url)

        languageList =[currentSoup,
                       get_soup("https://www.aes.org.cn/nyhjkxxb/ch/index.aspx")]
