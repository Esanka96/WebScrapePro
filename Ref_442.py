...
while url_index < len(url_list):
    try:
        ...
        url="https://www.zgylxtb.cn/api/api/Web/LastIssueList?_t=&PageSize=0&IssueId=0"
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Article_link = f"https://www.zgylxtb.cn/#/digest?ArticleID={All_articles[article_index]["ArticleID"]}"

                error_variable = "article title"
                Article_title=All_articles[article_index]["TitleE"]

                if article_index==0:
                    Article_title="Table of Contents"
                if article_index==1:
                    Article_title="Color pages"
                ...
                pdf_link=f"https://www.zgylxtb.cn/api/api/Web/OpenArticleFilebyGuidNew?Id={All_articles[article_index]["PDFFileNameUrlGUID"]}"
