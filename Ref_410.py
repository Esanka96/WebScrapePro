...
while url_index < len(url_list):
    try:
        ...
        url="https://aammt.tmmu.edu.cn/api/api/Web/LastIssueList?_t=&PageSize=0&IssueId=0"
        ...
        All_articles=list(filter(lambda title:title["TitleE"],json.loads(get_soup(url).text)["Data"]))
        ...
        first_line=f"{All_articles[0]["PublishYear"]} (Volume{All_articles[0]["Volume"]}) Issue:{All_articles[0]["IssueNumE"]}"
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Article_link = f"https://aammt.tmmu.edu.cn/en/#/digest?ArticleID={All_articles[article_index]["ArticleID"]}"
                ...
                pdf_link=f"https://aammt.tmmu.edu.cn/api/api/Web/OpenArticleFilebyGuidNew?Id={All_articles[article_index]["PDFFileNameUrlGUID"]}"

                error_variable = "xml link"
                xml_link=f"https://aammt.tmmu.edu.cn/api/api/Web/GetXML?Id={All_articles[article_index]["PDFFileNameUrlGUID"]}"
