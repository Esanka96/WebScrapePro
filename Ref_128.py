...
while url_index < len(url_list):
    try:
        ...
        try:
            issueYear=currentSoup.find("div",class_="journal-special-page active").find("h3",class_="inverted width-100").text.strip().split("|")

            try:
                Issue=re.sub(r'[^0-9]+','',issueYear[0])
            except:
            ...
            print("Failed to find issue and year")
            Issue,Year="",""
        ...
        lastSoup=get_soup("https://www.ernaehrungs-umschau.de"+currentSoup.find("div",class_="journal-special-page active").find("a",class_="no-highlight").get("href"))

        All_articles = [j for i in lastSoup.find("div",class_="regular-row journal-content").findAll("div",class_="accordion-content") for j in i.findAll("a")]
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Article_link="https://www.ernaehrungs-umschau.de"+All_articles[article_index].get("href")

                pdf_link="https://www.ernaehrungs-umschau.de"+get_soup(Article_link).find("div",class_="regular-row actions").find("ul",class_="pipe-separated-list").find("a").get("href")
                DOI=""
                ...
                if Check_duplicate.lower() == "true" and check_value:
                    ...
                    pdfkit.from_url(pdf_link, output_fimeName, configuration=config, options={'enable-local-file-access': ""})
