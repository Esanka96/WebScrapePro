...
while url_index < len(url_list):
    try:
        ...
        url="http://www.electricpower.com.cn/EN/1004-9649/current.shtml"
        ...
        languageList =[currentSoup,
                       get_soup("http://www.electricpower.com.cn/CN/1004-9649/current.shtml")]

        try:
            volumeYear = currentSoup.find("div",class_="njq").text.strip().split()
            try:
                Volume = volumeYear[-3]
            except:
        ...
        All_articles=currentSoup.find("form",{"id":"AbstractList"}).findAll("div",class_="noselectrow")
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                try:
                    pageRangeDoi = re.sub(r'\s+',' ',All_articles[article_index].find("dd",class_="kmnjq").text.strip())
                ...
                token = get_token('http://www.electricpower.com.cn/EN/1004-9649/current.shtml')
                pdf_link="http://www.electricpower.com.cn/EN/PDF/{}?token={}".format(DOI,token)
