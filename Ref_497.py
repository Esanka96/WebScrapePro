...
headers_json = {
    ...
    "Host": "www.photon.ac.cn",
    #"Referer":"https://www.photon.ac.cn/homeNav?lang=zh",
...
while url_index < len(url_list):
    try:
        ...
        soup_for_current_id = get_soup("https://www.photon.ac.cn/rc-pub/front/front-period/getPeriodTreeForPage?siteId=110&isBack=false&magType=1&page=0&size=10&timestamps=")
        current_id=json.loads(soup_for_current_id.text)["data"]["content"][0]["periods"][0]["id"]
        url=f"https://www.photon.ac.cn/rc-pub/front/front-article/getArticlesByPeriodicalIdGroupByColumn/{current_id}?showCover=false&timestamps="
        currentSoup=json.loads(get_soup_with_json(url).text)

        All_articles=[art for first in currentSoup["data"] for art in first["content"]]
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Identifier=Art_index["elocationId"]
                Page_range = ""
                Month,Day="",""

                error_variable = "article link"
                Article_link = f"https://www.photon.ac.cn/thesisDetails#{DOI}&lang=en"

                error_variable = "article title"
                Article_title=Art_index["enResName"]

                error_variable = "pdf link"
                pdf_link=f"https://www.photon.ac.cn/rc-pub/front/front-article/download?id={Id}&attachType=lowqualitypdf&token=&language=en"

                error_variable = "xml link"
                xml_link=f"https://www.photon.ac.cn/rc-pub/front/front-article/download?id={Id}&attachType=metaxml&token=&language=en"
                ...
                if Check_duplicate.lower() == "true" and check_value:
                    ...
                    data.append(
                        {"Title": Article_title, "DOI": DOI, "Publisher Item Type": "", "ItemID": "",
                         ...
                         "Year": Year,
                         "URL": Article_link, "SOURCE File Name": f"{pdf_count}.pdf", "XML File Name": f"{pdf_count}.xml","user_id": user_id})
