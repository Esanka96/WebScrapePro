...
def create_session():
    ...
    headers1 = {
        ...
        #"cookie": "ASP.NET_SessionId=rndvtn45aalwfui4ksd00w55",
        "host": "bopoe.cbpt.cnki.net",
        "pragma": "no-cache",
    ...
    secondUrl="http://bopoe.cbpt.cnki.net/WKD/WebPublication/paperDigestEng.aspx?paperID=87b7d57a-69eb-4a9b-935b-23bc0bd9d655"
    ...
    headers2 = {
        ...
        "host": "bopoe.cbpt.cnki.net",
        "pragma": "no-cache",
        "referer": "http://bopoe.cbpt.cnki.net/WKD/WebPublication/index.aspx",
        "upgrade-insecure-requests": "1",
        "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36"
    }
...
while url_index < len(url_list):
    try:
        ...
        url="http://bopoe.cbpt.cnki.net/WKD/WebPublication/index.aspx"
        ...
        languageList =[currentSoup,BeautifulSoup(new_session.get("https://bopo.cbpt.cnki.net/WKD/WebPublication/index.aspx?mid=bopo").content,"html.parser")]
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Article_link = "http://bopoe.cbpt.cnki.net/WKD"+Art_index.find("h3").a["href"].replace("..","").replace("paperDigest","paperDigestEng")
                ...
                try:
                    ...
                    Year, Volume, value1, Issue, Page_range="","","","",""
                DOI=""

                error_variable = "pdf link"
                pdf_id=Art_index.find("a",href=lambda link:link and "wfid" in link)["href"].split("wfid=")[-1]
                pdf_link=f"http://bopoe.cbpt.cnki.net/WKD/WebPublication/wkDownLoad.aspx?fileID={pdf_id}"
