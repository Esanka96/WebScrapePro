...
while url_index < len(url_list):
    try:
        ...
        url="https://hgxb.cip.com.cn/EN/0438-1157/current.shtml"
        ...
        languageList =[currentSoup,
                       get_soup("https://hgxb.cip.com.cn/CN/0438-1157/current.shtml")]
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                token=get_token("https://hgxb.cip.com.cn/EN/0438-1157/current.shtml")
                pdf_link="https://hgxb.cip.com.cn/EN/PDF/{0}?token={1}".format(DOI,token)
                ...
                if Check_duplicate.lower() == "true" and check_value:
                    ...
                    pdf_headers = {
                        ...
                        "Host": "hgxb.cip.com.cn",
                        "Pragma": "no-cache",
                        "Referer": "https://hgxb.cip.com.cn/EN/0438-1157/current.shtml",
