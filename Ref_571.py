...
while url_index < len(url_list):
    try:
        ...
        url="https://lxsj.cstam.org.cn/en/article/current"
        ...
        languageList =[currentSoup,
                       get_soup("https://lxsj.cstam.org.cn/cn/article/current")]
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                pdf_id=re.search(r"downloadpdf\('(.+?)'\)",Art_index.find("a",string=lambda text:text and "PDF" in text)["onclick"]).group(1)
                pdf_link=f"https://lxsj.cstam.org.cn/article/exportPdf?id={pdf_id}&language=en"
                ...
                if Check_duplicate.lower() == "true" and check_value:
                    ...
                    pdf_headers = {
                        ...
                        #"cookie": "Hm_lvt_98e670b96b2de2932e53a7bab162c9ca=1726750234; HMACCOUNT=89355045786DF1FC; JSESSIONID=A0171C04FCE501BC0023B898F63F9042; _sowise_user_sessionid_=ec9ce93f-a524-46b7-a872-3950b03cde20; Hm_lpvt_98e670b96b2de2932e53a7bab162c9ca=1726754333",
                        "host": "lxsj.cstam.org.cn",
                        "referer": "https://lxsj.cstam.org.cn/indexen.htm",
