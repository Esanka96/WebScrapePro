...
while url_index < len(url_list):
    try:
        ...
        url="https://www.chinaagrisci.com/EN/0578-1752/current.shtml"
        ...
        languageList =[currentSoup,
                       get_soup("https://www.chinaagrisci.com/CN/0578-1752/current.shtml")]
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Article_link = All_articles[article_index].find("a",class_="biaoti")["href"]
                ...
                token=get_token("https://www.chinaagrisci.com/EN/0578-1752/current.shtml")
                pdf_link="https://www.chinaagrisci.com/EN/PDF/{0}?token={1}".format(DOI,token)
                ...
                if Check_duplicate.lower() == "true" and check_value:
                    ...
                    pdf_headers = {
                        ...
                        #"Cookie": "Secure; JSESSIONID=CCD2343AC2305F117EE1B8A0EBD5F6AB; wkxt3_csrf_token=53211cc1-bf94-4595-94dc-8490c5449d14; Secure",
                        "Host": "www.chinaagrisci.com",
                        "Pragma": "no-cache",
                        "Referer": "https://www.chinaagrisci.com/EN/0578-1752/current.shtml",
