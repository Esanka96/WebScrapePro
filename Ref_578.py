...
while url_index < len(url_list):
    try:
        ...
        url="https://bhxb.buaa.edu.cn/bhzk/indexen.htm"
        ...
        languageList =[currentSoup,
                       get_soup("https://bhxb.buaa.edu.cn/bhzk/")]

        All_articles=list(filter(lambda art:art.find("div",class_="article-list-time"),currentSoup.find("div",id="current").findAll("div",class_="article-list")))
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                try:
                    yearPagerange=Art_index.find("div",class_="article-list-time").font.get_text(strip=True)
                ...
                pdf_id=Art_index["id"]
                pdf_link=f"https://bhxb.buaa.edu.cn/bhzk/article/exportPdf?id={pdf_id}&language=en"

                error_variable = "xml link"
                xml_link=f"https://bhxb.buaa.edu.cn/bhzk/article/exportXML?ids={pdf_id}&downType=XML&language=en"
                ...
                if Check_duplicate.lower() == "true" and check_value:
                    ...
                    pdf_headers = {
                        ...
                        #"cookie": "JSESSIONID=D68C2FA40ED0EFB25756E9A0FAB038A2; Hm_lvt_f365a144058b094a0637660eca01083b=1727175899,1727236538; HMACCOUNT=89355045786DF1FC; _sowise_user_sessionid_=6bf6133c-c003-4e33-a58c-520a4e211c75; Hm_lpvt_f365a144058b094a0637660eca01083b=1727237404",
                        "host": "bhxb.buaa.edu.cn",
