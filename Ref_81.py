...
while url_index < len(url_list):
    try:
        ...
        All_articles = current_soup.find('div', class_='view-content').findAll('div', class_='views-row')
        All_articles=list(filter(lambda x:x.find("a",class_="btn btn-primary"),All_articles))
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                try:
                    DOI=All_articles[article_index].find('div',class_='paper-doi').text.strip().rsplit('org/',1)[-1]
                except:
                ...
                try:
                    ...
                    Page_range = ""
                pdf_link='https://www.iieta.org'+All_articles[article_index].find('div',class_='paper-download').find('a').get('href')
