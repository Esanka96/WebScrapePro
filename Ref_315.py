...
while url_index < len(url_list):
    try:
        ...
        url="https://www.aeroweaponry.avic.com/EN/1673-5048/current.shtml"
        ...
        languageList =[currentSoup,
                       get_soup("https://www.aeroweaponry.avic.com/CN/1673-5048/current.shtml")]

        try:
            volumeIssue=currentSoup.find("span",class_="date").text.strip()
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                try:
                    doi_page_range = re.sub(r'\s+', " ", All_articles[article_index].find('span', class_='abs_njq').text.strip())
                    try:
                        Page_range = re.search(r"\): (.*?). DOI",doi_page_range).group(1)
                    except:
                        Page_range=""

                    try:
                        DOI=doi_page_range.rsplit("DOI: ",1)[-1].strip()
                    except:
                        DOI=""
                except:
                    DOI,Page_range="",""
                ...
                token=get_token("https://www.aeroweaponry.avic.com/EN/1673-5048/current.shtml")
                pdf_link="https://www.aeroweaponry.avic.com/CN/PDF/{0}?token={1}".format(DOI,token)
                ...
                if Check_duplicate.lower() == "true" and check_value:
                    ...
                    pdf_headers = {
                        ...
                        #"Cookie": "Secure; JSESSIONID=7D5CB424D0BCBAB049F829943B66A488; wkxt3_csrf_token=677c1d47-e195-4752-92a4-1ad510edfdaf; Secure",
                        "Host": "www.aeroweaponry.avic.com",
                        "Pragma": "no-cache",
