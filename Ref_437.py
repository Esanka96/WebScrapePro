...
while url_index < len(url_list):
    try:
        ...
        url="https://zkxb.xjtu.edu.cn/api/api/Web/LastIssueList?_t=&PageSize=0&IssueId=0"
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                Article_link = f"https://zkxb.xjtu.edu.cn/en/#/digest?ArticleID={All_articles[article_index]["ArticleID"]}"

                error_variable = "article title"
                Article_title=All_articles[article_index]["TitleE"].replace("\r","")
                ...
                pdf_link=f"https://zkxb.xjtu.edu.cn/api/api/Web/OpenArticleFilebyGuidNew?Id={All_articles[article_index]["PDFFileNameUrlGUID"]}"
